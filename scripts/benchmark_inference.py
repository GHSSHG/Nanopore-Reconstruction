...
from valid.pod5_reconstruct import (
    _build_model,
    _iter_source_specs,
    _load_json,
...
def _parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--config", type=Path, default=Path("configs/Foundation/offline.json"))
    ...
    parser.add_argument("--attention-backend", type=str, default=None, help="Override decoder pos-net attention backend")
...
def main() -> None:
    ...
    if args.attention_backend is not None:
        model_cfg["decoder_pos_net_attention_backend"] = str(args.attention_backend)
    ...
    summary = {
        ...
        "model": {
            "decoder_pos_net_attention_backend": str(model_cfg.get("decoder_pos_net_attention_backend")),
